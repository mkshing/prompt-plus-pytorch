    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                sample, res_samples = downsample_block(
                    ...
                    temb=emb,
                    encoder_hidden_states=encoder_hidden_states if encoder_hidden_states_list is None else encoder_hidden_states_list[select_idx],
        ...
        if self.mid_block is not None:
            sample = self.mid_block(
                sample,
                emb,
                encoder_hidden_states=encoder_hidden_states if encoder_hidden_states_list is None else
                encoder_hidden_states_list[select_idx],
                attention_mask=attention_mask,
                cross_attention_kwargs=cross_attention_kwargs,
            )
            if encoder_hidden_states_list is not None:
